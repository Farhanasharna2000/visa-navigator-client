        ...
        <div className='bg-gray-100 p-8 mb-8 rounded-lg'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-20 '>
                <div className='relative mb-8 md:mb-0'>
                    ...
                    <div className="bg-red-200 py-4 px-6 absolute bottom-[-20%] right-[25%] shadow-md hover:shadow-xl transition-transform transform hover:scale-105">
                        <h2 className="text-xl font-semibold text-center">Bilal Abbas</h2>
                        <p className="text-center text-blue-800">Migration Agent</p>
                    </div>
                    <div className="flex justify-center bg-orange-500 p-3  absolute left-[40%] rounded-full  top-[67%] shadow-md hover:shadow-xl transition-transform transform hover:scale-105">
